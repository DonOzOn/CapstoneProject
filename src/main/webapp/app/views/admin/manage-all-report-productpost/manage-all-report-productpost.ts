...
@Component({
  selector: 'app-manageallreportpost',
  templateUrl: './manage-all-report-productpost.html',
  styleUrls: ['./manage-all-report-productpost.scss'],
  providers: [ConfirmationService, MessageService]
})
export class ManageAllReportPostComponent implements OnInit {
