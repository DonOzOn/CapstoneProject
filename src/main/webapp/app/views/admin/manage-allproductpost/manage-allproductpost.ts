...
export class ManageAllProductpostComponent implements OnInit {
  ...
  productPostForm = this.fb.group({
    ...
    // eslint-disable-next-line
    numFloor: [null, [Validators.maxLength(2),Validators.max(200), Validators.pattern('^[0-9]*$')]],
    // eslint-disable-next-line
    numBathroom: [null, [Validators.maxLength(2),Validators.max(20), Validators.pattern('^[0-9]*$')]],
    // eslint-disable-next-line
    numBedroom: [null, [Validators.maxLength(2),Validators.max(20), Validators.pattern('^[0-9]*$')]],
